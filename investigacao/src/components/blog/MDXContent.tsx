...
export default function MDXContent({ children }: MDXContentProps) {
  return (
    <div className="mdx-content prose prose-invert prose-gold max-w-none
      ...
      prose-h1:mb-8
      prose-h1:mt-12
      prose-h1:text-green-400
      prose-h2:text-4xl
      prose-h2:font-bold
      prose-h2:mt-12
      prose-h2:mb-6
      prose-h2:text-green-400
      prose-h2:border-b
      prose-h2:border-green-500/30
      prose-h2:pb-3
      prose-h3:text-3xl
      prose-h3:font-semibold
      prose-h3:mt-10
      prose-h3:mb-4
      prose-h3:text-green-300
      prose-h4:text-2xl
      prose-h4:font-semibold
      prose-h4:mt-8
      prose-h4:mb-3
      prose-h4:text-green-200
      prose-p:text-slate-600 dark:text-navy-300
      prose-p:leading-relaxed
      prose-p:mb-4
      prose-a:text-green-400
      hover:prose-a:text-green-300
      ...
      prose-th:p-3
      prose-th:border
      prose-th:border-green-500/10
      prose-td:p-3
      prose-td:border
      prose-td:border-green-500/10
      prose-td:text-slate-600 dark:text-navy-300
      prose-img:rounded-xl
      prose-img:border
      prose-img:border-green-500/10
    ">
      {children}
    </div>
  );
