    ...
    <section className="py-32 bg-navy-50 dark:bg-white dark:bg-navy-900 relative overflow-hidden">
      ...
      <div className="container max-w-7xl px-4 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          <Badge variant="outline" className="mb-4 text-green-600 dark:text-green-400 border-green-400 bg-green-500/10">
            ...
            return (
              <Card
                ...
                className={`relative group hover:scale-105 transition-all duration-300 border-2 hover:shadow-2xl ${
                  portal.popular ? "border-green-500 shadow-xl scale-105 md:scale-110" : "border-navy-200 dark:border-slate-400 dark:border-navy-700"
                } bg-gradient-to-br ${portal.bgGradient}`}
              >
                {/* Badge */}
                {(portal.popular || portal.badge) && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <Badge className={`${portal.popular ? 'gradient-premium text-navy-950' : 'bg-slate-100 dark:bg-navy-800 text-green-400'} shadow-lg px-4 py-1 font-bold`}>
