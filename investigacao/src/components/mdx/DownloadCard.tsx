...
export default function DownloadCard({
  ...
  return (
    <a
      ...
      className="flex items-start gap-4 p-4 my-4 rounded-xl border border-green-500/10 bg-white dark:bg-white/50 dark:bg-navy-900/50 hover:bg-white dark:bg-navy-900 hover:border-green-500/20 transition-all group"
    >
      {/* File Icon */}
      ...
      {/* Download Icon */}
      <div className="flex-shrink-0 p-2 text-slate-500 dark:text-navy-400 group-hover:text-green-400 transition-colors">
        {external ? (
