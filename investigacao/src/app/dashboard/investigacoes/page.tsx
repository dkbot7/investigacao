          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-navy-800 border border-slate-400 dark:border-navy-700 rounded-lg text-slate-900 dark:text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 text-sm sm:text-base"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                size="sm"
                className="bg-green-500 hover:bg-green-600 text-navy-950 font-semibold whitespace-nowrap"
              >
                  ...
                  {paginatedFuncionarios.map((func, index) => (
                    ...
                    >
                      <td className="py-2 sm:py-3 px-2 sm:px-4">
                        <span className="text-slate-900 dark:text-white font-medium hover:text-green-400 transition-colors text-xs sm:text-sm">
                          {func.nome}
                        </span>
                      </td>
