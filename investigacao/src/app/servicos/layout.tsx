...
export const metadata: Metadata = {
  ...
  description: "Serviços de investigação particular e due diligence digital. Proteção para investidores, empresas e famílias com metodologia profissional validada.",
  openGraph: {
