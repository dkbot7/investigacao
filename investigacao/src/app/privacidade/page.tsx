        ...
        <div className="container max-w-4xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Política de Privacidade</h1>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">1. Introdução</h2>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">2. Controlador de Dados</h2>
            <div className="bg-white dark:bg-navy-900 p-6 rounded-lg border border-slate-300 dark:border-navy-800">
              <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-2"><strong>Razão Social:</strong> investigaree Serviços de Investigação Digital LTDA</p>
              <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-2"><strong>E-mail do Encarregado (DPO):</strong> privacidade@investigaree.com.br</p>
              <p className="text-slate-900 dark:text-slate-800 dark:text-white/80"><strong>Localização:</strong> Brasil</p>
            </div>
          </section>

          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">3. Dados Pessoais Coletados</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-4">Podemos coletar os seguintes tipos de dados pessoais:</p>

            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mt-6 mb-3">3.1 Dados de Identificação</h3>
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mt-6 mb-3">3.2 Dados de Navegação</h3>
            <ul className="list-disc list-inside text-slate-900 dark:text-slate-800 dark:text-white/80 space-y-2">
              <li>Endereço IP</li>
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mt-6 mb-3">3.3 Dados Fornecidos Voluntariamente</h3>
            <ul className="list-disc list-inside text-slate-900 dark:text-slate-800 dark:text-white/80 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">4. Finalidades do Tratamento</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-4">Utilizamos seus dados pessoais para as seguintes finalidades:</p>
            <ul className="list-disc list-inside text-slate-900 dark:text-slate-800 dark:text-white/80 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">5. Base Legal para o Tratamento</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-4">O tratamento de dados pessoais é realizado com base nas seguintes hipóteses legais (Art. 7º da LGPD):</p>
            <ul className="list-disc list-inside text-slate-900 dark:text-slate-800 dark:text-white/80 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">6. Compartilhamento de Dados</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-4">Seus dados pessoais podem ser compartilhados com:</p>
            <ul className="list-disc list-inside text-slate-900 dark:text-slate-800 dark:text-white/80 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">7. Seus Direitos (Art. 18 da LGPD)</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-4">Você possui os seguintes direitos em relação aos seus dados pessoais:</p>
            <ul className="list-disc list-inside text-slate-900 dark:text-slate-800 dark:text-white/80 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">8. Segurança dos Dados</h2>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">9. Retenção de Dados</h2>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">10. Transferência Internacional de Dados</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">11. Alterações nesta Política</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80">
          ...
          <section className="mb-12">
            ...
            <div className="bg-white dark:bg-navy-900 p-6 rounded-lg border border-slate-300 dark:border-navy-800">
              ...
              <p className="text-slate-900 dark:text-slate-800 dark:text-white/80 mb-2"><strong>Encarregado de Dados (DPO):</strong> dpo@investigaree.com.br</p>
              <p className="text-slate-900 dark:text-slate-800 dark:text-white/80"><strong>Site:</strong> www.investigaree.com.br</p>
            </div>
          </section>

          <section className="mb-12">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">13. Autoridade Nacional de Proteção de Dados</h2>
            <p className="text-slate-900 dark:text-slate-800 dark:text-white/80">
