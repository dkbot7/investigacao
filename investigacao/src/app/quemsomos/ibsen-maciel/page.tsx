    ...
    <>
      ...
      <main className="min-h-screen bg-white dark:bg-neutral-950">
        ...
        <section className="relative overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-navy-950 dark:via-navy-900 dark:to-navy-950" />
          ...
          <div className="relative container max-w-7xl px-4 py-16 md:py-24">
            <Link href="/quemsomos">
              <Button variant="ghost" className="mb-8 text-slate-900 dark:text-slate-700 dark:text-white/70 hover:text-white hover:bg-white/10">
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-2 flex flex-col items-center lg:items-start">
                <div className="relative">
                  ...
                  <div className="relative w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-blue-500 shadow-2xl">
                    <Image
                  ...
                  {/* Floating Badge */}
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-blue-500 text-navy-950 px-4 py-2 rounded-full font-bold text-sm shadow-lg whitespace-nowrap">
                    Advisory Board
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mt-8 w-full max-w-xs">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">1º</p>
                    <p className="text-xs text-slate-900 dark:text-slate-600 dark:text-white/60">PCE-PA 2019</p>
                  </div>
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
                    <Medal className="w-5 h-5 text-blue-400 mx-auto mb-1" />
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">1º</p>
                    <p className="text-xs text-slate-900 dark:text-slate-600 dark:text-white/60">Exército 2017</p>
                  </div>
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
                    <Users className="w-5 h-5 text-blue-400 mx-auto mb-1" />
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">6k+</p>
                    <p className="text-xs text-slate-900 dark:text-slate-600 dark:text-white/60">Peritos ANPAJ</p>
                  </div>
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
                    <Shield className="w-5 h-5 text-blue-400 mx-auto mb-1" />
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">IDCiber</p>
                    <p className="text-xs text-slate-900 dark:text-slate-600 dark:text-white/60">Comitê</p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-3 space-y-6">
                {/* Name & Title */}
                <div>
                  <p className="text-blue-400 font-medium tracking-wide uppercase text-sm mb-2">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-4 leading-tight">
                    Ibsen Rodrigues<br />
                    <span className="text-blue-400">Maciel</span>
                  </h1>
                  <p className="text-lg text-slate-900 dark:text-slate-700 dark:text-white/70 leading-relaxed max-w-2xl">
                ...
                <div className="flex flex-wrap items-center gap-6 pt-4">
                  <div className="flex items-center gap-2 text-slate-900 dark:text-slate-600 dark:text-white/60">
        ...
        <section className="py-20 bg-neutral-50 dark:bg-neutral-900">
          <div className="container max-w-7xl px-4">
            <div className="text-center mb-12">
              <Badge className="bg-blue-100 text-blue-700 border-blue-200 mb-4">Aprovações Públicas</Badge>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <Card key={i} className={`overflow-hidden transition-all hover:shadow-lg ${item.highlight ? 'ring-2 ring-blue-500/50' : ''}`}>
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div className={`w-14 h-14 rounded-xl flex items-center justify-center font-bold text-xl ${item.highlight ? 'bg-blue-500 text-navy-950' : 'bg-neutral-200 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-300'}`}>
                        {item.pos}
                      </div>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-navy-950 dark:via-navy-900 dark:to-navy-950 text-slate-900 dark:text-white">
          <div className="container max-w-7xl px-4">
            <div className="text-center mb-12">
              <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30 mb-4">Reconhecimento</Badge>
              <h2 className="text-3xl md:text-4xl font-bold">
                Condecorações e Honrarias
              </h2>
              <p className="text-slate-900 dark:text-slate-600 dark:text-white/60 mt-2 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-6 hover:bg-white/10 transition group">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30">Nov/2023</Badge>
                </div>
                <h3 className="text-lg font-bold mb-1 text-slate-900 dark:text-white">Medalha de Honra ao Mérito do GAECO</h3>
                ...
                <div className="flex items-center gap-2 text-xs text-slate-900 dark:text-slate-500 dark:text-white/50">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-6 hover:bg-white/10 transition group">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
                    <Award className="w-7 h-7 text-slate-900 dark:text-white" />
                  </div>
                  <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30">Nov/2025</Badge>
                </div>
                <h3 className="text-lg font-bold mb-1 text-slate-900 dark:text-white">Medalha de Reconhecimento FICCO/Pará</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-green-500/30 rounded-2xl p-6 hover:bg-white/10 transition group">
                ...
                <h3 className="text-lg font-bold mb-1 text-slate-900 dark:text-white">Medalha Força e Honra</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 hover:bg-white/10 transition group">
                ...
                <h3 className="text-lg font-bold mb-1 text-slate-900 dark:text-white">Membro Honorário ANPAJ</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-6 hover:bg-white/10 transition group">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
                    <Trophy className="w-7 h-7 text-navy-950" />
                  </div>
                  <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30">2019</Badge>
                </div>
                <h3 className="text-lg font-bold mb-1 text-slate-900 dark:text-white">1º Colocado - Perito Criminal</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-green-500/30 rounded-2xl p-6 hover:bg-white/10 transition group">
                ...
                <h3 className="text-lg font-bold mb-1 text-slate-900 dark:text-white">1º Colocado - Oficial do Exército</h3>
        ...
        <section className="py-20 bg-gradient-to-b from-white to-neutral-50 dark:from-neutral-950 dark:to-neutral-900">
          <div className="container max-w-7xl px-4">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="relative">
                {/* Line */}
                <div className="absolute left-6 md:left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 via-primary-500 via-blue-500 via-green-500 to-neutral-300 dark:to-neutral-700 rounded-full" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative flex gap-4 md:gap-8">
                    <div className="relative">
                      ...
                      <div className="absolute -top-1 -right-1 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center ring-2 ring-white dark:ring-neutral-900">
                        <CheckCircle className="w-3 h-3 text-slate-900 dark:text-white" />
                      </div>
                    </div>
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
                            <p className="text-sm font-semibold text-blue-700 dark:text-blue-400 mb-2">Conquista</p>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Computação Forense</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Coordenação Nacional</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">6.000+ Peritos</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Capacitação</Badge>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="relative flex gap-4 md:gap-8">
                    <div className="relative">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center z-10 shadow-lg shadow-blue-500/30 ring-4 ring-white dark:ring-neutral-900">
                        <Target className="w-6 h-6 md:w-7 md:h-7 text-slate-900 dark:text-white" />
                      </div>
                    </div>
                    <Card className="flex-1 overflow-hidden hover:shadow-lg transition-shadow">
                      <div className="h-1 bg-gradient-to-r from-blue-400 to-blue-600" />
                      <CardContent className="p-6">
                        <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
                          ...
                          <Badge variant="outline" className="px-3 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">2023 - Atual</Badge>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Cibersegurança</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Defesa Cibernética</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Pesquisa</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Infraestrutura Crítica</Badge>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="relative flex gap-4 md:gap-8">
                    <div className="relative">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center z-10 shadow-lg shadow-primary-500/30 ring-4 ring-white dark:ring-neutral-900">
                        <Shield className="w-6 h-6 md:w-7 md:h-7 text-slate-900 dark:text-white" />
                      </div>
                      <div className="absolute -top-1 -right-1 w-5 h-5 bg-blue-500 rounded-full flex items-center justify-center ring-2 ring-white dark:ring-neutral-900">
                    ...
                    <Card className="flex-1 overflow-hidden hover:shadow-lg transition-shadow border-2 border-primary-200 dark:border-primary-800">
                      ...
                      <CardContent className="p-6">
                        <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
                          ...
                          <Badge variant="outline" className="px-3 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">2019 - Atual</Badge>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Forense Computacional</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Crimes Cibernéticos</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Extração de Dados</Badge>
                          <Badge variant="outline" className="text-xs hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Laudos Periciais</Badge>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="relative flex gap-4 md:gap-8">
                    <div className="relative">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center z-10 shadow-lg shadow-blue-500/30 ring-4 ring-white dark:ring-neutral-900">
                        <BookOpen className="w-6 h-6 md:w-7 md:h-7 text-slate-900 dark:text-white" />
                      </div>
                    </div>
                    <Card className="flex-1 overflow-hidden hover:shadow-lg transition-shadow">
                      <div className="h-1 bg-gradient-to-r from-blue-400 to-blue-600" />
                  ...
                  <div className="relative flex gap-4 md:gap-8">
                    <div className="relative">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center z-10 shadow-lg shadow-indigo-500/30 ring-4 ring-white dark:ring-neutral-900">
                        <Database className="w-6 h-6 md:w-7 md:h-7 text-slate-900 dark:text-white" />
                      </div>
                    </div>
                    <Card className="flex-1 overflow-hidden hover:shadow-lg transition-shadow">
                      ...
                      <CardContent className="p-6">
                        <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
                          ...
                          <Badge variant="outline" className="px-3 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">2022 - 2024</Badge>
                        </div>
                  ...
                  <div className="relative flex gap-4 md:gap-8">
                    <div className="relative">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center z-10 shadow-lg shadow-green-500/30 ring-4 ring-white dark:ring-neutral-900">
                        <Medal className="w-6 h-6 md:w-7 md:h-7 text-slate-900 dark:text-white" />
                      </div>
                      <div className="absolute -top-1 -right-1 w-5 h-5 bg-blue-500 rounded-full flex items-center justify-center ring-2 ring-white dark:ring-neutral-900">
                        <Trophy className="w-3 h-3 text-navy-950" />
                      </div>
                    ...
                    <Card className="flex-1 overflow-hidden hover:shadow-lg transition-shadow">
                      ...
                      <CardContent className="p-6">
                        <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
                          ...
                          <Badge variant="outline" className="px-3 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">2016 - 2018</Badge>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4">
                            ...
                            <div className="flex flex-wrap gap-1">
                              <Badge variant="outline" className="text-xs border-green-300 text-green-700 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Informática</Badge>
                              <Badge variant="outline" className="text-xs border-green-300 text-green-700 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Segurança da Informação</Badge>
                              <Badge variant="outline" className="text-xs border-green-300 text-green-700 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Engenharia</Badge>
                              <Badge variant="outline" className="text-xs border-green-300 text-green-700 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Combate a Incêndio</Badge>
                            </div>
                          </div>
                        </div>
        ...
        {/* Operações Policiais */}
        <section className="py-20 bg-slate-50 dark:bg-navy-950 text-slate-900 dark:text-white">
          <div className="container max-w-7xl px-4">
            <div className="text-center mb-12">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    ...
                    <p className="text-xs text-slate-900 dark:text-slate-500 dark:text-white/50">Prisões</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    <p className="text-2xl font-bold text-red-400">104</p>
                    <p className="text-xs text-slate-900 dark:text-slate-500 dark:text-white/50">Buscas</p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-1">
                  <Badge variant="outline" className="text-xs border-white/20 text-slate-900 dark:text-slate-700 dark:text-white/70 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Falsos leilões</Badge>
                  <Badge variant="outline" className="text-xs border-white/20 text-slate-900 dark:text-slate-700 dark:text-white/70 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Golpe PIX</Badge>
                  <Badge variant="outline" className="text-xs border-white/20 text-slate-900 dark:text-slate-700 dark:text-white/70 hover:bg-navy-700 hover:text-white hover:border-navy-700 transition-all duration-200">Clonagem WhatsApp</Badge>
                </div>
              </div>
        ...
        <section className="py-20">
          <div className="container max-w-7xl px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* XibéSec 2024 */}
              <Card className="overflow-hidden group hover:shadow-xl transition-all">
                <div className="h-2 bg-gradient-to-r from-blue-500 to-amber-500" />
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
              ...
              {/* Coletiva */}
              <Card className="overflow-hidden group hover:shadow-xl transition-all">
                <div className="h-2 bg-gradient-to-r from-blue-500 to-blue-500" />
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
