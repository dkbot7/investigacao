...
export default function RecursosPage() {
  ...
  const getPriceLabel = (price: string) => {
    switch (price) {
      ...
      case "freemium": return { label: "Freemium", color: "bg-green-500/20 text-green-400" };
      case "pago": return { label: "Pago", color: "bg-green-500/20 text-green-400" };
  ...
  return (
    <>
        ...
        {showApiForm && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-lg bg-white dark:bg-navy-900 rounded-2xl border border-green-500/20 overflow-hidden"
            >
              {/* Header do Modal */}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2.5 bg-slate-100 dark:bg-navy-800 border border-green-500/10 rounded-lg text-slate-900 dark:text-white placeholder:text-slate-900 dark:text-navy-500 focus:outline-none focus:border-green-500/30"
                          />
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2.5 bg-slate-100 dark:bg-navy-800 border border-green-500/10 rounded-lg text-slate-900 dark:text-white placeholder:text-slate-900 dark:text-navy-500 focus:outline-none focus:border-green-500/30 resize-none"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2.5 bg-slate-100 dark:bg-navy-800 border border-green-500/10 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:border-green-500/30"
                        >
      ...
      <main className="min-h-screen bg-slate-50 dark:bg-navy-950">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">
                      Recursos{" "}
                      <span className="text-green-500">Investigação</span>
                    </h1>
        ...
        {/* Filtros */}
        <section className="py-6 border-y border-green-500/10 bg-white dark:bg-navy-900/30">
                        ...
                        {resources.map((resource, index) => {
                            ...
                            <>
                              ...
                              <div className="flex items-start justify-between gap-3 mb-3">
                                <div className="flex-1 min-w-0">
                                  ...
                                  <h3 className="text-slate-900 dark:text-white font-semibold group-hover:text-green-400 transition-colors line-clamp-2">
                                    {resource.name}
                                  </h3>
                                </div>
                                {!isInternal && (
                                  <ExternalLink className="w-4 h-4 text-slate-900 dark:text-navy-500 group-hover:text-green-500 flex-shrink-0 transition-colors" />
                                )}
                              </div>
                              ...
                              {/* Tags */}
                              <div className="flex flex-wrap gap-1.5 mt-3 pt-3 border-t border-green-500/10">
                          ...
                          if (isFormResource) {
                            return (
                              <motion.button
                                ...
                                className={`group block p-5 bg-white dark:bg-navy-900/50 border rounded-xl transition-all hover:border-green-500/50 h-full text-left w-full ${
                                  resource.featured ? "border-green-500/30" : "border-green-500/10"
                                }`}
                              >
                                {CardContent}
                              </motion.button>
                            ...
                            return (
                              ...
                              >
                                <motion.div
                                  ...
                                  viewport={{ once: true }}
                                  transition={{ delay: index * 0.05 }}
                                  className={`group block p-5 bg-white dark:bg-navy-900/50 border rounded-xl transition-all hover:border-green-500/50 h-full ${
                                    resource.featured ? "border-green-500/30" : "border-green-500/10"
                                  }`}
                                >
                                  {CardContent}
                          ...
                          return (
                            <motion.a
                              ...
                              viewport={{ once: true }}
                              transition={{ delay: index * 0.05 }}
                              className={`group block p-5 bg-white dark:bg-navy-900/50 border rounded-xl transition-all hover:border-green-500/50 ${
                                resource.featured ? "border-green-500/30" : "border-green-500/10"
                              }`}
                            >
                              {CardContent}
