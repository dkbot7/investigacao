...
export const metadata: Metadata = {
  title: "Contato | investigaree",
  description: "Entre em contato com a investigaree pelo WhatsApp. Atendimento rápido e sigiloso.",
};

const WHATSAPP_NUMBER = "5547992611117";
const WHATSAPP_MESSAGE = encodeURIComponent("Olá! Gostaria de saber mais sobre os serviços de investigação da investigaree.");
    ...
    <main className="min-h-screen bg-navy-950">
      ...
      <header className="bg-navy-900 border-b border-navy-800">
        <div className="container max-w-4xl mx-auto px-4 py-6">
          ...
          <p className="text-white/60 mt-2">Fale conosco pelo WhatsApp</p>
        </div>
      </header>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-12">
        <div className="text-center space-y-8">
          ...
          {/* WhatsApp Card */}
          <div className="bg-navy-900 p-8 md:p-12 rounded-2xl border border-navy-800 max-w-xl mx-auto">
            <div className="mb-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-bold rounded-full transition-all duration-300 shadow-lg hover:shadow-green-500/30 text-lg"
            >
              <svg
                viewBox="0 0 24 24"
                className="w-6 h-6"
            ...
            <p className="text-white/50 text-sm mt-6">
              Clique no botão acima para falar conosco diretamente pelo WhatsApp
            </p>
          </div>
          ...
          <div className="space-y-4 text-white/70">
            <p className="text-lg">
              Nosso atendimento é 100% pelo WhatsApp para garantir sua privacidade e agilidade.
            </p>
            <p>
