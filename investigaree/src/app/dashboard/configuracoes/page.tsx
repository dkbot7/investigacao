      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-64 flex-shrink-0">
            <div className="bg-navy-900 border border-navy-700 rounded-xl p-2 space-y-1">
              {tabs.map((tab) => {
                const Icon = tab.icon;
                ...
                >
                  <div className="flex items-center justify-between border-b border-navy-700 pb-4">
                    <div>
                      ...
                      <p className="text-sm text-white/60">Atualize suas informações de perfil</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      ...
                      <button className="absolute bottom-0 right-0 p-1.5 bg-gold-500 rounded-full text-navy-950 hover:bg-gold-600 transition-colors">
                        <Camera className="w-4 h-4" />
                      </button>
                    </div>
                    <div>
                      <p className="text-sm text-white/60">Foto de perfil</p>
                      <p className="text-xs text-white/40">JPG, PNG ou GIF. Máx 2MB.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2.5 bg-navy-800 border border-navy-600 rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-gold-500/50"
                    ...
                    <div className="md:col-span-2 space-y-2">
                      <label className="block text-sm font-medium text-white/80">Endereço</label>
                      <div className="relative">
              ...
              {activeTab === "notificacoes" && (
                ...
                >
                  <div className="border-b border-navy-700 pb-4">
                    ...
                    <p className="text-sm text-white/60">Escolha como deseja receber atualizações</p>
                  </div>

                  <div className="space-y-4">
                    <h3 className="text-sm font-medium text-white/70 uppercase tracking-wide">Por Email</h3>

                    <label className="flex items-center justify-between p-4 bg-navy-800/50 rounded-lg cursor-pointer hover:bg-navy-800 transition-colors">
                      <div>
                        <p className="text-white font-medium">Novos Relatórios</p>
                        <p className="text-sm text-white/60">Receba um email quando um relatório for concluído</p>
                      </div>
                      <input
                        type="checkbox"
                        ...
                        className="w-5 h-5 rounded bg-navy-700 border-navy-600 text-gold-500 focus:ring-gold-500"
                      />
                    </label>

                    <label className="flex items-center justify-between p-4 bg-navy-800/50 rounded-lg cursor-pointer hover:bg-navy-800 transition-colors">
                      <div>
                        <p className="text-white font-medium">Atualizações do Sistema</p>
                        <p className="text-sm text-white/60">Novidades e melhorias da plataforma</p>
                      </div>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-navy-800/50 rounded-lg cursor-pointer hover:bg-navy-800 transition-colors">
                      <div>
                        ...
                        <p className="text-sm text-white/60">Promoções e ofertas especiais</p>
                      </div>
                      <input
                        type="checkbox"
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-medium text-white/70 uppercase tracking-wide">Notificações Push</h3>

                    <label className="flex items-center justify-between p-4 bg-navy-800/50 rounded-lg cursor-pointer hover:bg-navy-800 transition-colors">
                      <div>
                        <p className="text-white font-medium">Status de Investigações</p>
                        <p className="text-sm text-white/60">Mudanças de status nas suas investigações</p>
                      </div>
                      <input
                        type="checkbox"
                    ...
                    <label className="flex items-center justify-between p-4 bg-navy-800/50 rounded-lg cursor-pointer hover:bg-navy-800 transition-colors">
                      <div>
                        <p className="text-white font-medium">Relatórios Prontos</p>
                        <p className="text-sm text-white/60">Quando um relatório estiver disponível</p>
                      </div>
                      <input
                        type="checkbox"
              ...
              {activeTab === "seguranca" && (
                ...
                >
                  <div className="border-b border-navy-700 pb-4">
                    ...
                    <p className="text-sm text-white/60">Altere sua senha e configure a segurança</p>
                  </div>

                  <div className="space-y-4">
                    <h3 className="text-sm font-medium text-white/70 uppercase tracking-wide">Alterar Senha</h3>

                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white/80">Senha Atual</label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-12 py-2.5 bg-navy-800 border border-navy-600 rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-gold-500/50"
                          placeholder="••••••••"
                        />
                        <button
                          type="button"
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white/80">Nova Senha</label>
                      <div className="relative">
                        <Key className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/40" />
                        <input
                      ...
                      <p className="text-xs text-white/40">Mínimo de 8 caracteres</p>
                    </div>

                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white/80">Confirmar Nova Senha</label>
                      <div className="relative">
                        <Key className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/40" />
                        <input
                  ...
                  <div className="flex justify-end pt-4 border-t border-navy-700">
                    <Button
                      ...
                      className="bg-gold-500 hover:bg-gold-600 text-navy-950 font-semibold disabled:opacity-50"
                    >
                      {saving ? (
                        <>
                          <Loader2 className="w-4 h-4 mr-2 animate-spin" />
              ...
              {activeTab === "assinatura" && (
                ...
                >
                  <div className="border-b border-navy-700 pb-4">
                    ...
                    <p className="text-sm text-white/60">Visualize o status da sua assinatura</p>
                  </div>

                  {/* Current Plan */}
                  <div className="bg-gradient-to-r from-gold-500/10 to-gold-600/5 border border-gold-500/30 rounded-xl p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-white/60">Plano Atual</p>
                        <h3 className="text-2xl font-bold text-gold-400">Profissional</h3>
                      </div>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-sm font-medium text-white/70">Recursos incluídos:</h4>
