      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-full lg:w-64">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 bg-navy-800 border border-navy-700 rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 text-sm"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
        ...
        <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm mt-1">
              Foram identificados <strong className="text-white">{CLIENTE_01_CANDIDATOS.length} funcionarios</strong> que
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">{CLIENTE_01_CANDIDATOS.length}</p>
                <p className="text-xs text-white/50">Total Candidatos</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">{eleitos}</p>
                <p className="text-xs text-white/50">Eleitos</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">{suplentes}</p>
                <p className="text-xs text-white/50">Suplentes</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">{naoEleitos}</p>
                <p className="text-xs text-white/50">Nao Eleitos</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-white/70">Filtrar por Partido</span>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-navy-800/50 border-b border-navy-700">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-medium text-white/60">Cargo Pleiteado</th>
