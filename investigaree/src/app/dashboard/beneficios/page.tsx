    ...
    <div className="p-4 lg:p-8">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-full lg:w-64">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 bg-navy-800 border border-navy-700 rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 text-sm"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
        ...
        <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-4 flex items-start gap-3">
          <DollarSign className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-0.5" />
          <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">{beneficiariosUnicos}</p>
                <p className="text-xs text-white/50">Beneficiarios</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Total Recebido</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Media por Pessoa</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Ano Principal</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-navy-900 border border-navy-700 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-white/70">Filtrar por Tipo de Beneficio</span>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-navy-800/50 border-b border-navy-700">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-medium text-white/60">Tipo de Beneficio</th>
                ...
                {filteredBeneficios.map((beneficio) => (
                  ...
                  >
                    <td className="py-3 px-4">
                      <span className="text-white font-medium hover:text-cyan-400 transition-colors">
                        {beneficio.nome}
                      </span>
                    </td>
        ...
        <div className="bg-navy-900/50 border border-navy-700 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-medium text-white mb-1">Sobre os Beneficios Identificados</h4>
