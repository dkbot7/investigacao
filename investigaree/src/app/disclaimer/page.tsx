    ...
    <main className="min-h-screen bg-navy-950">
      ...
      <header className="bg-navy-900 border-b border-navy-800">
        <div className="container max-w-4xl mx-auto px-4 py-6">
          ...
          <p className="text-white/80 mt-1">Isenção de Responsabilidade e Aviso Legal</p>
          <p className="text-white/60 mt-2 text-sm">Última atualização: 04 de dezembro de 2025</p>
        </div>
      </header>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">2. Limites Legais e Éticos</h2>

            <h3 className="text-lg font-semibold text-white mt-6 mb-3">2.1 Conformidade Legal</h3>
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">2.2 Práticas Proibidas</h3>
          ...
          <section className="mb-12">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.1 Informações Fornecidas</h3>
            <p className="text-white/80">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.2 Decisões do Cliente</h3>
            <p className="text-white/80">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.3 Fontes de Informação</h3>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">4. Uso Apropriado dos Serviços</h2>

            <h3 className="text-lg font-semibold text-white mt-6 mb-3">4.1 Finalidades Legítimas</h3>
            <p className="text-white/80 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">4.2 Compromisso do Cliente</h3>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">5. Conteúdo do Blog e Materiais Educativos</h2>
            <p className="text-white/80 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">6. Links e Conteúdo de Terceiros</h2>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">9. Limitação de Danos</h2>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">10. Jurisdição e Lei Aplicável</h2>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">11. Alterações</h2>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            ...
            <div className="bg-navy-900 p-6 rounded-lg border border-navy-800">
              ...
              <p className="text-white/80 mb-2"><strong>Jurídico:</strong> juridico@investigaree.com.br</p>
              <p className="text-white/80"><strong>Site:</strong> www.investigaree.com.br</p>
            </div>
          </section>

          {/* Documentos Relacionados */}
          <section className="mb-8 p-6 bg-navy-900/50 rounded-xl border border-navy-800">
            <h3 className="text-lg font-semibold text-white mb-4">Documentos Relacionados</h3>
