      ...
      <div className="container max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">1. O que são Cookies?</h2>
          ...
          <section className="mb-12">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">2.1 Cookies Essenciais (Necessários)</h3>
            <div className="bg-navy-900 p-4 rounded-lg border border-navy-800 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white mt-8 mb-3">2.2 Cookies de Desempenho (Analíticos)</h3>
            <div className="bg-navy-900 p-4 rounded-lg border border-navy-800 mb-4">
              <p className="text-white/80 mb-2">
            ...
            <h3 className="text-lg font-semibold text-white mt-8 mb-3">2.3 Cookies de Funcionalidade</h3>
            <div className="bg-navy-900 p-4 rounded-lg border border-navy-800 mb-4">
              <p className="text-white/80 mb-2">
            ...
            <h3 className="text-lg font-semibold text-white mt-8 mb-3">2.4 Cookies de Marketing</h3>
            <div className="bg-navy-900 p-4 rounded-lg border border-navy-800 mb-4">
              <p className="text-white/80 mb-2">
                <strong>Base Legal:</strong> Consentimento
              </p>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">3. Gestão de Cookies</h2>

            <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.1 Banner de Consentimento</h3>
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.2 Alterar Preferências</h3>
            <p className="text-white/80">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">3.3 Configurações do Navegador</h3>
            <p className="text-white/80 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">4. Cookies de Terceiros</h2>
            <p className="text-white/80 mb-4">
            ...
            <div className="bg-navy-900 p-4 rounded-lg border border-navy-800">
              <p className="text-white/80 mb-2"><strong>Google Analytics</strong></p>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">5. Outras Tecnologias de Rastreamento</h2>
            <p className="text-white/80 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">7. Atualizações desta Política</h2>
            <p className="text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-bold text-white mb-4">9. Referências Legais</h2>
            <ul className="list-disc list-inside text-white/80 space-y-2">
