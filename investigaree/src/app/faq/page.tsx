  ...
  },
  {
    ...
    perguntas: [
      ...
      },
      {
        ...
        resposta: "Nosso Advisory Board é composto por especialistas de alto nível que validam nossa metodologia. Inclui Ibsen Rodrigues Maciel, Perito Criminal Oficial em Forense Computacional da Polícia Científica do Pará e Diretor Nacional de Perícias em Computação Forense da ANPAJ."
      },
      {
      ...
      <main className="min-h-screen bg-navy-950 pt-20">
        ...
        <div className="container max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="mt-16 text-center">
            ...
            <a
              href="https://wa.me/5547992611117?text=Ol%C3%A1!%20Tenho%20uma%20d%C3%BAvida%20sobre%20os%20servi%C3%A7os%20da%20investigaree."
              target="_blank"
