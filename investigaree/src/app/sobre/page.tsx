...
export const metadata: Metadata = {
  ...
  description: "Conheça a investigaree - Due Diligence Digital com metodologia validada por Perito Criminal Oficial.",
};
      ...
      <main className="min-h-screen bg-navy-950 pt-20">
        ...
        <section className="py-16">
          <div className="container max-w-5xl mx-auto px-4 text-center">
            ...
            <a
              href="https://wa.me/5547992611117?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20da%20investigaree."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-bold rounded-full transition-all text-lg"
            >
