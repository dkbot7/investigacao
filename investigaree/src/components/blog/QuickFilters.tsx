          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${
                isActive
                  ? "text-navy-950"
                  : "text-navy-700 dark:text-navy-100 hover:text-navy-900 dark:hover:text-white hover:bg-navy-100 dark:hover:bg-navy-800/80"
              }`}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 text-left">
                          ...
                          <span className={`text-xs ${isActive ? "text-navy-800" : "text-navy-600 dark:text-navy-300"}`}>
                            {level.description}
                          </span>
                        </div>
          ...
          >
            ...
            {selectedTopic && (
              <motion.button
                ...
                animate={{ scale: 1 }}
                onClick={() => handleTopicClick(selectedTopic.slug)}
                className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium text-navy-900 dark:text-navy-100 hover:opacity-80 transition-opacity"
