        ...
        >
          ...
          <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-slate-400 dark:border-navy-700 bg-slate-100 dark:bg-navy-800/95 backdrop-blur-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-900 dark:text-slate-600 dark:text-white/60">Cadastre pessoa ou empresa para investigação</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white border-b border-slate-400 dark:border-navy-700 pb-2">Dados Básicos</h3>
            ...
            {/* Contato */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white border-b border-slate-400 dark:border-navy-700 pb-2">Contato</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-slate-900 dark:text-white">Escopo da Investigação</label>
            ...
            <div className="sticky bottom-0 flex flex-col gap-3 pt-6 border-t border-slate-400 dark:border-navy-700 bg-slate-100 dark:bg-navy-800">
