...
export default function SocialProof() {
  return (
    <section className="py-16 bg-white dark:bg-slate-50 dark:bg-navy-950 border-y border-navy-200 dark:border-slate-300 dark:border-navy-800">
      <div className="container max-w-7xl px-4">
        {/* Quem Atendemos */}
        <div className="text-center">
          <h3 className="text-lg font-semibold text-navy-600 dark:text-slate-600 dark:text-navy-300 mb-8">
            Quem protegemos
          </h3>
